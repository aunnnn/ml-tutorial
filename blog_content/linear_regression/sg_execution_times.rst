...
Computation times
=================
**00:01.897** total execution time for **blog_content_linear_regression** files:

- **00:01.867**: :ref:`sphx_glr_blog_content_linear_regression_linear_regression_tutorial.py` (``linear_regression_tutorial.py``)
